System.register(['@angular/core', './item', '@angular/router', './item.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, item_1, router_1, item_service_1;
    ...
    return {
        ...
        execute: function() {
            ItemDetailEditComponent = (function () {
                function ItemDetailEditComponent(router, activatedRoute, itemService) {
                    this.router = router;
                ...
                ItemDetailEditComponent.prototype.onInsert = function (item) {
                    var _this = this;
                    return this.itemService.add(item).subscribe(function (data) { _this.item = data; _this.router.navigate(['']); }, function (error) { console.log(error); });
                };
                ItemDetailEditComponent.prototype.onUpdate = function (item) {
                    var _this = this;
                    return this.itemService.update(item).subscribe(function (data) { _this.item = data; _this.router.navigate(['']); }, function (error) { console.log(error); });
                };
                ItemDetailEditComponent.prototype.onDelete = function (item) {
                    var _this = this;
                    return this.itemService.delete(item.Id).subscribe(function (data) { _this.item = data; _this.router.navigate(['']); }, function (error) { console.log(error); });
                };
                ItemDetailEditComponent.prototype.onView = function (item) {
                    this.router.navigate(['item/view', item.Id]);
                };
                ItemDetailEditComponent.prototype.onBack = function (item) {
                    this.router.navigate(['']);
                };
                ItemDetailEditComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [router_1.Router, router_1.ActivatedRoute, item_service_1.ItemService])
